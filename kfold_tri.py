...
predictions = [list(y_pred).count("Conversation Management"), list(y_pred).count("Active Discussion"), list(y_pred).count("Creative Conflict")]
figure1 = Figure()
...
actual = [list(y_test).count("Conversation Management"), list(y_test).count("Active Discussion"), list(y_test).count("Creative Conflict")]
figure2 = Figure()
